...
const Footer = () => (
  ...
  <footer className="pv4 ph3 ph5-ns tc">
    ...
    <a className="link hover-silver gray dib h2 w2 mr3" href="https://twitter.com/bamiogunfemi" title="Twitter">
      <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fillRule="evenodd"
    ...
    <a className="link hover-silver gray dib h2 w2 mr3" href="https://linkedin.com/in/bami-ogunfemi" title="LinkedIn">
      <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fillRule="evenodd"
    ...
    <a  className="link hover-silver gray dib h2 w2 mr3" href="mailto:ayobamiarafat09@gmail.com?subject=Hi%Bami%You%Rock%Let's%Work%Together">
      <img src="https://img.icons8.com/carbon-copy/24/000000/new-post.png"/>    </a>
